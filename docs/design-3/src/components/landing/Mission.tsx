    ...
    <section id="mission" className="py-24 bg-sand relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <pattern id="wave-pattern" x="0" y="0" width="50" height="10" patternUnits="userSpaceOnUse">
            <path
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-16 max-w-3xl mx-auto leading-relaxed">
            We create meaningful dive journeys for those who share our deep love for
            the ocean. Every expedition is crafted with intention—prioritizing
            quality over quantity, safety without compromise, and genuine respect
            for the underwater world and its communities.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-ocean-light to-aqua flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
