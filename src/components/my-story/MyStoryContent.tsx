...
import { Anchor, Compass, Heart, Waves, Users, Sparkles } from 'lucide-react'
        ...
        <div className='container mx-auto px-6 relative z-10'>
          <div className='max-w-4xl mx-auto text-center mb-16'>
            ...
            <div className='space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed'>
              <p>
                What makes these journeys truly special isn&apos;t only where we
                go, but <strong className='text-navy'>who we share them with.</strong>
              </p>
              <p>
                The ocean is where I slow down, breathe deeply and feel most
                present. It&apos;s where I gain perspective and return to balance.
              </p>
              <p>
              ...
              <p>
                ...
                naturally. People meet around a shared respect for the ocean, for
                simplicity and for a more conscious way of traveling.
              </p>
            </div>
          </div>
        ...
        <div className='container mx-auto px-6 relative z-10'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <div className='space-y-4 text-lg md:text-xl text-primary-foreground/80 leading-relaxed'>
              <p>
                And I want you to feel safe &mdash; knowing your journey has been
                designed with care, attention and trusted partners.
              </p>
